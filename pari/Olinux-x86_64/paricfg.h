...
#define UNIX
#define GPHELP "\"/home/aurelien/local2/bin/gphelp\""
#define GPDATADIR "/home/aurelien/local2/share/pari"
#define SHELL_Q '\''

#define PARIVERSION "GP/PARI CALCULATOR Version 2.8.0 (development 19497-d8b350e)"
#define PARIINFO "amd64 running linux (x86-64/GMP-5.1.3 kernel) 64-bit version"
#define PARI_VERSION_CODE 133120
#define PARI_VERSION(a,b,c) (((a) << 16) + ((b) << 8) + (c))
#define PARI_VERSION_SHIFT 8
#define PARI_VCSVERSION "19497-d8b350e"
#define PARI_MT_ENGINE "single"

#define PARI_DOUBLE_FORMAT -
#define GCC_VERSION "gcc version 4.8.4 (Ubuntu 4.8.4-2ubuntu1~14.04.3)"
#define ASMINLINE
